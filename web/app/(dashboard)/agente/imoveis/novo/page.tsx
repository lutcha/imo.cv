...
const LISTING_VALUES = ['rent', 'sale', 'vacation', 'new_construction'] as const;
      ...
      const payload = {
        ...
        properties: {
          ...
          year_built: form.yearBuilt.trim()
            ? Math.max(1800, parseInt(form.yearBuilt, 10) || 1800)
            : null,
    ...
    <div className="mx-auto max-w-2xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex flex-wrap gap-3 pt-4">
          {typeof form.step === 'number' && form.step > 1 && (
            <Button
              type="button"
              variant="outline"
              onClick={() =>
                update({ step: (form.step as number - 1) as 1 | 2 | 3 | 4 })
              }
            >

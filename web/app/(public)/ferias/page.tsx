...
export const metadata: Metadata = {
  title: 'Alojamento Local & Férias em Cabo Verde – imo.cv',
  description:
    'Encontra casas, apartamentos e vilas para arrendamento de curta duração em Cabo Verde. Férias nas ilhas com toda a comodidade.',
};
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <section
        ...
        style={{ background: 'linear-gradient(135deg, #0d9488 0%, #0a766e 100%)' }}
      >
        {/* Dot-grid overlay */}
        <div
        ...
        <div className="relative mx-auto max-w-4xl px-4 text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-lg text-white/80">
            O marketplace de referência para estadias de curta duração nas ilhas.
            Casas, apartamentos e vilas a um clique.
          </p>
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            {['Sal', 'Boa Vista', 'Santiago', 'São Vicente'].map((island) => (
              <a
                key={island}
                href={`/ferias?island=${encodeURIComponent(island)}`}
      ...
      <IslandExploreSection
        ...
        subtitle="Descobre oportunidades únicas em todo o arquipélago."
      />
